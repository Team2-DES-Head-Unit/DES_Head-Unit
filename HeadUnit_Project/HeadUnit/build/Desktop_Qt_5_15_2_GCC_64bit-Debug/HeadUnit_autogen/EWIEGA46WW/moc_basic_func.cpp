...
QT_MOC_LITERAL(3, 26, 11), // "dateChanged"
QT_MOC_LITERAL(4, 38, 11), // "currentTime"
QT_MOC_LITERAL(5, 50, 11) // "currentDate"

    },
    "TimeProvider\0timeChanged\0\0dateChanged\0"
    "currentTime\0currentDate"
};
...
void TimeProvider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (TimeProvider::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TimeProvider::dateChanged)) {
                *result = 1;
                return;
            }
        }
