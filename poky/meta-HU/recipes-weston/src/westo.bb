...
do_install() {
    ...
    install -m 0644 ${WORKDIR}/westo.service ${D}${systemd_system_unitdir}/westo.service
    install -d ${D}${systemd_system_unitdir}
...
SYSTEMD_SERVICE:${PN} = "westo.service"
SYSTEMD_AUTO_ENABLE = "enable"
SYSTEMD_SERVICE:${PN} = "app.service"
SYSTEMD_AUTO_ENABLE = "enable"


FILES:${PN} += "${systemd_system_unitdir}/westo.service"
